...
public class JBox2DGamePhysicsManagerFactory implements GamePhysicsManagerFactory {
    ...
    public JBox2DGamePhysicsManager create(GameEventManager aEventManager, ThreadingManager aThreadingManager) {
        ...
        aEventManager.register(null, GameObjectInstanceAddedToScene.EVENTTYPE, new GameEventListener<GameObjectInstanceAddedToScene>() {
            @Override
        ...
        aEventManager.register(null, ApplyImpulseToGameObjectInstance.EVENTTYPE, new GameEventListener<ApplyImpulseToGameObjectInstance>() {
            @Override
        ...
        aEventManager.register(null, ApplyForceToGameObjectInstance.EVENTTYPE, new GameEventListener<ApplyForceToGameObjectInstance>() {
            @Override
        ...
        aEventManager.register(null, DisableDynamicPhysics.EVENTTYPE, new GameEventListener<DisableDynamicPhysics>() {
            @Override
            public void handleGameEvent(DisableDynamicPhysics aEvent) {
                thePhysicsManager.disableDynamicPhysicsOn(aEvent.object);
            }
        });
        aEventManager.register(null, EnableDynamicPhysics.EVENTTYPE, new GameEventListener<EnableDynamicPhysics>() {
            @Override
            public void handleGameEvent(EnableDynamicPhysics aEvent) {
                thePhysicsManager.enableDynamicPhysicsOn(aEvent.object);
            }
        });
        aEventManager.register(null, GameObjectConfigurationChanged.EVENTTYPE, new GameEventListener<GameObjectConfigurationChanged>() {
            @Override
